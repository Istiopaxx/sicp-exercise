...
; "The problem is that the complex-number selectors were never defined for complex numbers, just for
...
; -> (magnitude ('rectangular 3 . 4)) : complex type
; -> (apply-generic 'magnitude ('rectangular 3 4))
; -> (magnitude (3 4)) : rectangular type
; -> (sqrt (+ (square (real-part (3 4))) (square (imag-part (3 4))))) : rectangular type
; -> 5
